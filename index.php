...
<html>
	...
	<body>
		...
		<div id="header-image" data-role="header" data-theme="<?php echo $theme ?>">
		    <h1><a href="#page1"><img src="img/logo.gif" alt="LOGO"></a></h1>
		</div>
		<div data-role="footer" data-theme="<?php echo $theme ?>">
			<h1>Powered by <a href="http://mobilegrows.com/">MobileGrows</a> | <a href="http://originalflyingpizza.com/" rel="external">Desktop Site</a></h1>
		</div>
		<!-- page 1 ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
		<div data-role="page" id="page1" data-theme="<?php echo $theme ?>">
		  ...
		  <div data-role="main" class="ui-content" data-theme="<?php echo $theme ?>">
				...
				<fieldset class="ui-grid-a" data-theme="<?php echo $theme ?>">
					...
					<div class="ui-block-a"><a href="#myPopuptelephone" data-rel="popup" class="ui-btn ui-icon-phone ui-alt-icon ui-nodisc-icon ui-btn-icon-left" data-transition="turn">Call<br>US</a></div>
					<!-- ovdje se upisuje grad i adresa iz koje  -->
					<div class="ui-block-b" id="findUS"><a href="#myPopup" class="ui-btn ui-icon-location ui-alt-icon ui-nodisc-icon ui-btn-icon-right buttons-radius" data-rel="popup" data-transition="slide">Find<br>US</a></div>
<!-- 
						<script>
							...
							if(/Android|webOS|Opera Mini/i.test(navigator.userAgent) ) {
								...
								dugme.setAttribute('class', "ui-btn ui-icon-location ui-alt-icon ui-nodisc-icon ui-btn-icon-right buttons-radius");
								dugme.setAttribute('href',"geo:0,0?q=<?php echo $adresa; ?>,<?php echo $grad; ?>,<?php echo $skracenica; ?>");
								dugme.innerHTML="Find<br>US";
				...
				<div class="ui-grid-a" data-theme="<?php echo $theme ?>">
                    <div class="ui-block-a"><a class="ui-btn ui-alt-icon ui-nodisc-icon ui-icon-bars ui-btn-icon-left buttons-radius" href="#home" data-transition="<?php echo $transitionefect ?>">Menu</a></div>
                    <div class="ui-block-b"><a class="ui-btn ui-alt-icon ui-nodisc-icon ui-icon-info ui-btn-icon-right buttons-radius" href="#home" data-transition="<?php echo $transitionefect ?>">History</a></div>
				</div>
				<div class="ui-grid-a" data-theme="<?php echo $theme ?>">
                    <div class="ui-block-a"><a class="ui-btn ui-alt-icon ui-nodisc-icon ui-icon-info ui-btn-icon-left buttons-radius" href="#home" data-transition="<?php echo $transitionefect ?>">Contest</a></div>
                    <div class="ui-block-b"><a class="ui-btn ui-alt-icon ui-nodisc-icon ui-icon-info ui-btn-icon-right buttons-radius" href="#home" data-transition="<?php echo $transitionefect ?>">Media</a></div>
				</div>
				<div class="ui-grid-a" data-theme="<?php echo $theme ?>">
                    <div class="ui-block-a"><a class="ui-btn ui-alt-icon ui-nodisc-icon ui-icon-info ui-btn-icon-left buttons-radius" href="#home" data-transition="<?php echo $transitionefect ?>">Coupons /<br>Special Offers</a></div>
                    <div class="ui-block-b"><a class="ui-btn ui-alt-icon ui-nodisc-icon ui-icon-mail ui-btn-icon-right buttons-radius" href="#contactform" data-transition="<?php echo $transitionefect ?>">Contact<br>US</a></div>
				</div>
		  </div>
			...
			<!-- POPUP FOR FIND US -->
			<h2>The Original Flying Pizza</h2>
		  <p><b>Located in Downtown Dayton</b></p>
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<section id="navigation-menu-home">
						<ul id="menu-home">
							...
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Coupons / Special Offers</a></li>
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Contest</a></li>
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Media</a></li>
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">History</a></li>							
		...
		<div id="patientform" data-role="page" data-theme="<?php echo $theme ?>">
			<div data-role="main" class="ui-content" >
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					...
					<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a"><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="documents/Anx.doc" target="_blank" data-transition="<?php echo $transitionefect ?>">Follow-Up - Office Visit - PLEASE FILL OUT FOR EACH VISIT</a></div>
					</div>
					<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
						<div class="ui-block-a"><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="documents/big.doc" target="_blank" data-transition="<?php echo $transitionefect ?>">Assessment - Bipolar Spectrum Conditon</a></div>
					</div>
					<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
						<div class="ui-block-a"><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="documents/Bipolar.doc" target="_blank" data-transition="<?php echo $transitionefect ?>">Assessment - Mood Questionnaire</a></div>
					</div>
					<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
						<div class="ui-block-a"><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="documents/Office.doc" target="_blank" data-transition="<?php echo $transitionefect ?>">Assessment - Anxiety</a></div>
					</div>
